...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/powerarrow-dark-new"
--theme.wallpaper                                 = theme.dir .. "/wall.png"
--theme.wallpaper                                 = "~/Pictures/wallpapers/anime/thumb-1920-714226.png"
...
theme.keyboard_us                               = theme.dir .. "/icons/united-states.svg"
theme.keyboard_ru                               = theme.dir .. ".icons/russia.svg"
...
-- Keyboard layout
theme.keyboard_layout =  awful.widget.keyboardlayout()
...
--    s.mytasklist = awful.widget.tasklist(s, awful.widget.tasklist.filter.currenttags, awful.util.tasklist_buttons)
    ...
    right_widgets = {}
    --table.insert(right_widgets, layout = wibox.layout.fixed.horizontal)
    for i = 1,#widget_list,1
        do
            ...
            local arrow = separators.arrow_left(color_prev, color)

            table.insert(right_widgets, arrow)
...
--             wibox.container.background(theme.keyboard_layout, theme.bg_focus),
--             arrl_dl,
--             clock,
--             spr,
--             arrl_ld,
