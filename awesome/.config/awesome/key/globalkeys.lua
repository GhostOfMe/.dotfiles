...
-- appearance
awful.key({modkey}, "a", function() awful.spawn.with_shell(vars.config_path .. "/scripts/appearance.sh") end,
    {
...
awful.key({modkey}, "Tab", 
    function()
        if cycle_prev then awful.client.focus.history.previous()
        else awful.client.focus.byidx(-1)
        end
        ---@diagnostic disable-next-line
        if client.focus then client.focus:raise() end
    end,
...
-- MPD control
awful.key({}, "XF86AudioRaiseVolume", function() awful.util.spawn("rmpc volume +5") end,
    {
        description = "rmpc volume up",
        group       = "widgets"
    }
), awful.key({}, "XF86AudioLowerVolume", function() awful.util.spawn("rmpc volume -5") end,
    {
        description = "rmpc volume down",
        group       = "widgets"
    }
),
awful.key({}, "XF86AudioMute", function() awful.util.spawn("amixer -D pulse set Master 1+ toggle") end),
awful.key({}, "XF86AudioPlay", function() awful.util.spawn("rmpc togglepause") end,
    {
        description = "rmpc pause/play",
        group       = "widgets"
    }
),
awful.key({}, "XF86AudioStop", function()awful.util.spawn("rmpc stop") end,
    {
        description = "rmpc stop",
        group       = "widgets"
    }
), awful.key({}, "XF86AudioNext", function() os.execute("rmpc next") end,
    {
        description = "rmpc next",
        group       = "widgets"
    }
),
awful.key({}, "XF86AudioPrev", function() os.execute("rmpc prev") end, 
    {
...
clientkeys = my_table.join( -- Windoe resize
--    awful.key({ modkey, "Shift"   }, "Next",   function () awful.client.incwfact(-0.01)  end),
--    awful.key({ modkey, "Shift"   }, "Prior",  function (c) c:relative_move(-22, -20,  40,  40) end),
--    awful.key({ modkey, "Alt"    }, "Right",     function () awful.tag.incmwfact( 0.01)    end),
--    awful.key({ modkey, "Shift"    }, "Left",     function () awful.tag.incmwfact(-0.01)    end),
--    awful.key({ modkey, "Alt"    }, "Down",     function () awful.client.incwfact( 0.01)    end),
