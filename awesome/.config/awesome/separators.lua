...
-- Right
function separators.arrow_right(col1, col2, col3)
    ...
    widget.update = function(col1, col2, col3)
        widget.col1 = col1
        widget.col2 = col2
        widget.col3 = col3
...
-- Left
function separators.arrow_left(col1, col2, col3)
    local widget = wibox.widget.base.make_widget()
    widget.col1 = col1
    widget.col2 = col2
